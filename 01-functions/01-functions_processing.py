...
print(mean(mydict))
print(' good, and now imagine you have a list used \n as input for the function')
print(mean(mylist))
print(' if input will be a string:')
print(mean('cat'))

print('Other options:')
if type("abc") == str and type([1, 2, 3]) == list and isinstance("abc", str) and isinstance([1, 2, 3], list):
    print('Ok')
else:
    print('Not Ok')

print('what about prompt input:')
...
def flavour(input_str):
    if isinstance(input_str, str):
        ...
        return 'It is needed to enter string to process input'
